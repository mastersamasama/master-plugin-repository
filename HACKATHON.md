...
- ✅ 填写提交表（队伍信息 + 说明）：[提交表链接](https://okg-block.sg.larksuite.com/share/base/form/shrlg8ofWhLJotSJdkIaQy9PxMg)
...
4. 把生成的 `.zip` 文件上传到提交表：[提交表链接](https://okg-block.sg.larksuite.com/share/base/form/shrlg8ofWhLJotSJdkIaQy9PxMg)
...
**评委 / Judges**: Stephnie Xu, Alan Xu, Eden Jiang, Abel Duolaitike, Jim Lin, Jeff Shan, Chenyang Liu, Ken Wong
...
4. 到 [提交表](https://okg-block.sg.larksuite.com/share/base/form/shrlg8ofWhLJotSJdkIaQy9PxMg) 上传 zip + Demo
不需要任何 GitHub 操作！
...
3. **提交表** —— [扫描二维码填写](https://okg-block.sg.larksuite.com/share/base/form/shrlg8ofWhLJotSJdkIaQy9PxMg)
...
- **提交表**: https://okg-block.sg.larksuite.com/share/base/form/shrlg8ofWhLJotSJdkIaQy9PxMg
